...
export function Forecast() {
  ...
  const monthsAhead = useUiStore((s) => s.horizonMonths);
  ...
  return (
    <div className="forecast-view">
      ...
      {engine.pools().length === 0 ? (
        <EmptyState icon="forecast" title="Nothing to forecast yet" description="Add disciplines, roles and project requirements in Team to see a capacity forecast, or clear the filter above if one is active." />
      ) : (
        <>
